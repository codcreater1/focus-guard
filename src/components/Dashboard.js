...
export default function Dashboard({ config, sessionStart, onStop, pushToast }) {
  ...
  // Listen for kills (App.js feeds via toast but we also track locally)
  useEffect(() => {
        ...
        <div style={css.ringWrap}>
          <svg width="240" height="240" style={{ transform: 'rotate(-90deg)' }}>
            ...
            <circle
              ...
              strokeLinecap="round"
              style={{ transition: 'stroke-dashoffset 0.5s linear', filter: 'drop-shadow(0 0 8px #6c63ff88)' }}
            />
          </svg>
          <div style={css.timeText}>
            <div style={css.timeVal}>{formatTime(remaining)}</div>
